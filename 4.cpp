...
answer++;
        ...
        if(A[0][0]==1 || A[0][1]==1) {/*cout<<"f";*/answer++; m=0;}

        else{/*cout<<"f"<<"f";*/ m=0;answer++;answer++;}
    }
    else{
               if(A[0][0]==0)
               {
                   if (A[0][1]==0 && A[1][0]==0 && A[1][1]==1)
                   {
                        ...
                        ltwogorforOO(Ai, mi);
                        ltwovertforOI(Au,mu);
                        if(m==0 || mi==0 || mu==0){/*cout<<"f";*/answer++;}//переделать и проверить
                           ...
                           if (A[0][1]==0 && A[1][0]==0)
                           {
                              // cout<<endl;
                                ...
                                while (mu!=0)
                                    rec(Au, mu, answer);
                               //создает три массива, с помощью функций
                           }
                           else
                           if(A[0][1]==0)
                           {
                                ...
                                loneforOO(A, m);
                                ltwogorforOO(Ai, mi);
                                if(m==0 || mi==0){answer++;}//переделать и проверить

                                while (m!=0)
                                    rec(A, m, answer);
                                while (mi!=0)
                                    rec(Ai, mi, answer);
                               //создает два массива, с помощью функций
                           }
                           else
                              if(A[1][0]==0)
                           {
                                ...
                                loneforOO(A, m);
                                ltwovertforOI(Ai, mi);
                                if(m==0 || mi==0){/*cout<<"f";*/answer++;}//переделать и проверить
               ...
               else//значит левый верх угол закрыт(=1), а правый открыт
                {
                            if(A[0][0]==1 && A[0][1]==1)
                            { rewrite(A, m);
                                rec(A, m, answer);
...
void ch(bool ** &A, int &n, int &ch)
{
        ...
        if(A[n-1][0]==1 && A[n-1][1]==1)
    {
        ...
        {if(i!=0 || i!=n-1)ch++;
            ...
            if (A[i][0]==1 && A[i+1][1]==1) ch++;
        else
        {
         if (A[i][1]==1 && A[i+1][0]==1) ch++;
        }
    }
    ch++;
}
